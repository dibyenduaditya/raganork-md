...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '✪⏤͟͞★⃝ꪶ‎𝐀ᴅɪᴛʏᴀ-𝐗ᴅ-𖥘✪͜͡➺;[ !! < 𝐌ʀ.x-𝐀ᴅɪᴛʏᴀ > !! ];https://i.imgur.com/1F5nSBL.mp4;https://whatsapp.com/channel/0029VaWgCOH1iUxUofORBN3K',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "[ !! < 𝐌ʀ.x-𝐀ᴅɪᴛʏᴀ > !! ]",
    BOT_NAME: process.env.BOT_NAME || '<< 𝐈ᴢᴜᴋᴏ - 𝐗ᴅ >>',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '𝐌ʀ.x;𝐀ᴅɪᴛʏᴀ⚡;https://i.imgur.com/HeTAbau.jpeg' : process.env.AUDIO_DATA,
